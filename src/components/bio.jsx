    ...
    <section id="bio">
      ...
      <div className="profile">
        ...
        <div className="bio-skills">
          ...
          <p>
            <span>Skills: </span>JavaScript/TypeScript, HTML, CSS, Tailwind, React, Node, Express, EJS, SQL, PostgreSQL, Mongoose/MongoDB, Python, Django, FastAPI, Flask, Go, Echo, Git, GitHub
          </p>
        </div>
      </div>
    </section>
