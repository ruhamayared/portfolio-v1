    ...
    <section id="bio">
      ...
      <div className="profile">
        ...
        <div className="bio-skills">
          ...
          <p>
            <span>Skills: </span>Java, JavaScript/TypeScript, HTML, CSS, Tailwind, React, Node.js, Express, EJS, SQL, PostgreSQL, Mongoose/MongoDB, Python, Django, FastAPI, Flask, Go, Echo, Git, GitHub, Amazon Web Services (AWS), Docker, Kubernetes, Terraform, Ansible, YAML
          </p>
        </div>
      </div>
    </section>
