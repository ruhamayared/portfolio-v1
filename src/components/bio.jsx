    ...
    <section id="bio">
      ...
      <div className="profile">
        ...
        <div className="bio-skills">
          ...
          <p>
            <span>Skills: </span>JavaScript/TypeScript, HTML, CSS, Tailwind, React, Node.js, Express, EJS, SQL, PostgreSQL, Mongoose/MongoDB, Python, Django, FastAPI, Flask, Go, Echo, Rust, Git, GitHub, Amazon Web Services (AWS)
          </p>
        </div>
      </div>
    </section>
